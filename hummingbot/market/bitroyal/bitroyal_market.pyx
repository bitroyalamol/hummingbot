...
cdef class BitroyalMarket(MarketBase):
    ...
    BITROYAL_API_ENDPOINT = "https://appicoinmartprod.alphapoint.com:8443/AP"
    ...
    def bitroyal_auth(self) -> BitroyalAuth:
        """
        :return: BitroyalAuth class (This is unique to bitroyal market).
        Read more here: https://docs.bitroyal.com/?python#signing-a-message
        """
    ...
    async def _api_request(self,
        ...
        """
        A wrapper for submitting API requests to Bitroyal
    ...
    cdef object c_get_fee(self,
        ...
        *required
        ...
        # Fee info from https://bitroyalexchange.com/fees
        cdef:
            object maker_fee = Decimal("0.0085")
            object taker_fee = Decimal("0.01")
        ...
        for tracked_order in tracked_orders:
            ...
            if execute_amount_diff > s_decimal_0:
                order_filled_event = OrderFilledEvent(
                    ...
                    # Bitroyal's websocket stream tags events with order_id rather than trade_id
    ...
    async def list_bitroyal_accounts(self) -> Dict[str, str]:
        """
        Gets a list of the user's bitroyal accounts via rest API
        :returns: json response
        """
    ...
    async def get_deposit_address(self, asset: str) -> str:
        ...
        so that the bot can deposit funds into bitroyal
        :returns: json response
        """
