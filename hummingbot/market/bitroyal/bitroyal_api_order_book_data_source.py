        ...
        async with aiohttp.ClientSession() as client:
            ...
            for index, trading_pair in enumerate(trading_pairs):
                try:
                    ...
                    snapshot_msg: OrderBookMessage = BitroyalOrderBook.snapshot_message_from_exchange(
                        snapshot,
                        snapshot_timestamp,
                    ...
                    async for raw_msg in self._inner_messages(ws):
                        ...
                        if msg_type is None:
                            ...
                            if msg_type == "done" and "price" not in msg:
                                ...
                                continue
                            order_book_message: OrderBookMessage = BitroyalOrderBook.diff_message_from_exchange(msg)
